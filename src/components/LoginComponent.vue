...
<template>
    ...
    <form @submit.prevent="authUser">
        ...
        <button type="submit"
            class="mt-4 text-white desktop-xl:text-2xl bg-black px-4 py-2 border-2 rounded border-black hover:bg-white dark:hover:bg-main-dark-bg hover:text-black">Pääse sisse</button>
    </form>
</template>
